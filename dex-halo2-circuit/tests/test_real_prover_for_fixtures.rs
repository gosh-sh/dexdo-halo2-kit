...
//! the `gen_hermez_kzg_and_dark_dex_keys` bin (or, for historical / test-only
//! reproduction of the pre-Hermez blobs, the legacy
//! `gen_legacy_gen_srs_dark_dex_keys` bin).
//!
...
//! ```bash
//! cargo test --test test_real_prover_for_fixtures test_dark_dex_keygen -- --nocapture
//! cargo test --test test_real_prover_for_fixtures test_dark_dex_prove -- --nocapture
//! cargo test --test test_real_prover_for_fixtures test_dark_dex_verify -- --nocapture
//! cargo test --test test_real_prover_for_fixtures test_dark_dex_prove_and_verify_all_fixtures -- --nocapture
//! ```
